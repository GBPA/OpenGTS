...
//  2015/05/03 v2.5.9,  2015/09/24 v2.6.0,  2016/01/17 v2.6.1,  2016/06/10 v2.6.2,
//  2016/10/03 v2.6.3,
//  2017/04/13 v2.6.4,
// ----------------------------------------------------------------------------
package org.opengts;
...
public class Version
{
    ...
    public  static final String COPYRIGHT = "Copyright 2007-2017, GeoTelematic Solutions, Inc.";

    // ------------------------------------------------------------------------

    // -- This string is parsed via 'grep' & 'sed' scripts.
    // -- ONLY the version value specified within the quotes should change.
    private static final String VERSION = "2.6.5"; // 2.6.5-B62, 2.6.4-B91, 2.6.3-B70
    ...
    private static final long PACKAGE_TIMESTAMP = 1507606617L;
