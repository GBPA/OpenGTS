    ...
    implements GeoPointProvider
{
    ...
    public static final String ARG_ADDR             = "addr";   // address
    ...
    **/
    ...
    /**
    *** Sets the address for this Cell Tower location
    *** @param addr  The address for this Cell Tower location
    **/
    public void setAddress(String addr)
    {
        this.address = StringTools.trim(addr);
    }
    ...
    **/
    ...
    {
        return !StringTools.isBlank(this.address);
    }

    /**
    *** Gets the address for this Cell Tower location in meters
    *** @return  The address
    **/
    ...
    **/
    public RTProperties getRTProperties(RTProperties rtp)
    {
        ...
        if (this.hasAddress()) {
            rtp.setString(ARG_ADDR, this.getAddress());
        }
        return rtp;
    }
