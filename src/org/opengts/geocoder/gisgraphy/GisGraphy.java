...
//       <QTime>13</QTime>
//       <result>
//          <distance>2090.77719332909</distance>
//          <name>Arad</name>
//          <adm1Code>02</adm1Code>
//          <adm1Name>Arad</adm1Name>
...
//          <lat>46.18333053588867</lat>
//          <lng>21.316669464111328</lng>
//          <placeType>city</placeType>
//          <openstreetmapId>25721593</openstreetmapId>
//          <zipCodes>
//              <zipCode>317121</zipCode>
//          </zipCodes>
//          <google_map_url>https://www.google.fr/maps/preview#!q=46.21333053588867+21.316669464111328</google_map_url>
//          <yahoo_map_url>http://maps.yahoo.com/place/?lat=46.18333053588867&amp;amp;lon=21.316669464111328</yahoo_map_url>
//          <openstreetmap_map_url>http://www.openstreetmap.org/#map=14/46.18333053588867/21.316669464111328</openstreetmap_map_url>
    ...
    implements ReverseGeocodeProvider, SubdivisionProvider
{
    ...
    **/
    ...
    private String getStreetReverseGeocodeURL(GeoPoint gp) 
    {
        ...
        if (radiusM > 0.0) {
            sb.append("&radius=").append(radiusM);
        }
        sb.append("&from=1&to=1&format=xml&placetype=city&indent=true");
        return sb.toString();
    }
    ...
    private Document GetXMLDocument(String url) 
    {
         try {
            ...
            Print.logError("HTTP IO error: " + hioe + " [response: " + hioe.getResponseMessage() + "]");
            return null;
