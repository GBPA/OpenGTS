        ...
        if (reqState.getCommandName().equals(COMMAND_PWD_CHANGE)) {
            ...
            if (SubmitMatch(submit,i18n.getString("ChangePassword.change","Change"))) {
                ...
                if (user != null) {
                    ...
                    if (!user.checkPassword(privLabel,pwdOld,false/*suspend?*/)) {
                    ...
                    if (!pwdHandler.validateNewPassword(pwdNew1,user.getLastEncodedPasswords(),pwdMsg)) {
                        ...
                        m = i18n.getString("ChangePassword.invalidPasswordFormat","Invalid Password Format: {0}",  // UserErrMsg
                            pwdMsg.toString(locale));
                        error = true;
                    } else {
                        user.setDecodedPassword(privLabel, pwdNew1, false);
                        try {
                            user.save();
                    ...
                    I18N.Text pwdMsg = new I18N.Text();
                    if (!account.checkPassword(privLabel,pwdOld,false/*suspend?*/)) {
                    ...
                    if (!pwdHandler.validateNewPassword(pwdNew1,account.getLastEncodedPasswords(),pwdMsg)) {
                        ...
                        account.setDecodedPassword(privLabel, pwdNew1, false);
                        try {
                            account.save();
