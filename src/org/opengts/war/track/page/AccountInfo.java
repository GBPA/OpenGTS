    ...
    implements Constants
{
    ...
    // parameters
    public  static final String PARM_ACCOUNT_ID         = "a_id";
    public  static final String PARM_ACCOUNT_DESC       = "a_desc";
    ...
    public  static final String PARM_MAX_COMMANDS       = "a_maxPing";
    public  static final String PARM_TOT_COMMANDS       = "a_totPing";
            ...
            public void write(PrintWriter out) throws IOException {
              ...
              //ComboOption geocoderMode     = privLabel.getEnumComboOption(Account.getGeocoderMode(currAcct)    );
                ...
                if (maxPingCnt > 0) {
                    ...
                    out.print  ("<td class='"+CommonServlet.CSS_ADMIN_VIEW_TABLE_DATA+"'>");
                    out.print  (Form_TextField(PARM_MAX_COMMANDS, false, String.valueOf(maxPingCnt), 5, 5));
                    ...
                    out.print  (Form_TextField(PARM_TOT_COMMANDS, false, String.valueOf(remaining) , 5, 5));
                    out.print  ("</td>");
                    out.println("</tr>");
                }
