    ...
    extends ReportMenu
{
    ...
    public ReportMenuDriverPerformance()
    {
        ...
        this.setPageName(PAGE_MENU_RPT_DRIVERPERF);
    ...
    {
        return MenuBar.MENU_REPORTS_DRIVER_PERFORM;
    }
    ...
    public String getNavigationDescription(RequestProperties reqState)
    {
        PrivateLabel privLabel = reqState.getPrivateLabel();
        I18N i18n = privLabel.getI18N(ReportMenuDriverPerformance.class);
        return super._getNavigationDescription(reqState,i18n.getString("ReportMenuDriverPerformance.navDesc","Driver Performance"));
    }
    ...
    public String getNavigationTab(RequestProperties reqState)
    {
        PrivateLabel privLabel = reqState.getPrivateLabel();
        I18N i18n = privLabel.getI18N(ReportMenuDriverPerformance.class);
        return super._getNavigationTab(reqState,i18n.getString("ReportMenuDriverPerformance.navTab","Driver Performance"));
    }
