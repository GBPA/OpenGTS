...
//     -Include "calCurrentYear", "calCurrentMonth1", "calCurrentDay" in JS vars.
// ----------------------------------------------------------------------------
...
public class Calendar
{
        ...
        throws IOException
    {
        ...
        String             timeZoneS  = reqState.getTimeZoneString(null);
        ...
        JavaScriptTools.writeJSVar(out, "calSelectedTMZ"    , timeZoneS);           // selected  TimeZone
        ...
        /* current date [2.6.4-B12] */
        DateTime nowDT = new DateTime(timeZone);
        JavaScriptTools.writeJSVar(out, "calCurrentYear"    , nowDT.getYear());
        JavaScriptTools.writeJSVar(out, "calCurrentMonth1"  , nowDT.getMonth1());
        JavaScriptTools.writeJSVar(out, "calCurrentDay"     , nowDT.getDayOfMonth());
