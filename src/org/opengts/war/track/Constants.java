...
public interface Constants
{
  ...
  //public  static final String PARM_REQSTATE               = CommonServlet.PARM_REQSTATE;
    ...
    public  static final String PARM_SA_RELOGIN_PASS        = "saRelogin";
    ...
    // ------------------------------------------------------------------------
    // Previous login times (prior to current login)

    public  static final String PRIOR_USER_LOGIN            = "priorLoginTime_user";
    public  static final String PRIOR_ACCOUNT_LOGIN         = "priorLoginTime_account";
    ...
    public  static final String PAGE_MENU_RPT_DRIVERPERF    = "menu.rpt.drvrPerf";      // "driver.performance"
    public  static final String PAGE_MENU_RPT_DEVICEPERF    = "menu.rpt.devPerf";       // "device.performance"
    ...
    public  static final String PAGE_MAP_DASHBOARD          = "map.dashboard";          // GPS map tracking
    public  static final String PAGE_MAP_SHARE              = "map.share";              // GPS map tracking
    ...
    public  static final String PAGE_ELOGHOS_FRAME          = "eloghos.info";           // ELog/HOS display frame
