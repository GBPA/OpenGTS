    ...
    implements ReportPresentation
{
        ...
        throws ReportException
    {
        ...
        /* report title row */
        {
            String rptTitle = rd.getReportTitle(); // HTML title
        ...
        throws ReportException
    {
        ...
        pw.print(XmlFilter(isSoapRequest,accountID));
        ...
        pw.print(XmlFilter(isSoapRequest,rd.getReportTitle()));                          // TAG_Title value
        ...
        if (rptFormat.equals(ReportURL.Format.EMAIL)) { // FORMAT_EMAIL
            ...
            try {
                ...
                String frEmail  = smtpProps.getFromEmailType("report"); // REPORT
                ...
                if (StringTools.isBlank(toEmail)) {
                    ...
                    // -- report subtitle (should be Device/Group selection) [2.6.2-B14]
                    StringBuffer subTitle = new StringBuffer();
                    ReportDeviceList rdl = rd.getReportDeviceList();
                    if (rd.isDeviceGroupReport()) {
                    ...
                    Print.logInfo("Report Email queued/sent (via "+smtpHost+"): ["+accountID+"] " + toEmail);
        ...
        throws ReportException
    {
        ...
        /* header */
        rptSS.setHeaderTitle(rd.getReportTitle()); // XLS Excel title
