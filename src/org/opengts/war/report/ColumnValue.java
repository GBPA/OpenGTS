...
public class ColumnValue
{
    ...
    **/
    public ColumnValue(ColumnValue other)
    {
        ...
        if (other != null) {
            ...
            this.linkButton     = other.linkButton;
        }
    }
    ...
    **/
    ...
    /**
    *** Returns true if this column has a specific defined CSS class, false otherwise
    *** @return True if this column has a specific defined CSS class
    **/
    ...
    **/
    ...
    {
        return this.setLinkURL(url, null, false);
    }
    ...
    *** @param button  True if the clickable link should be displayed as a button
    *** @return This ColumnValue instance
    **/
    public ColumnValue setLinkURL(String url, String target, boolean button)
    {
        this.linkURL    = url;
    ...
    *** @return This ColumnValue instance
    **/
    public ColumnValue setLinkURL(URIArg url, String target, boolean button)
    {
        return this.setLinkURL(((url != null)? url.toString() : null), target, button);
    }
    ...
    **/
    ...
    /**
    *** Returns true if the link display should be a button
    **/
