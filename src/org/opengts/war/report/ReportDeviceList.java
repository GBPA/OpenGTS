    ...
    extends DBRecord<ReportDeviceList> // not really a database table
{
    ...
    **/
    ...
    /** 
    *** Gets the device for the named ID (must already exist in the device map) 
    **/
    ...
    /**
    *** Removes the device for the named ID
    **/
    public boolean removeDevice(String devID)
    {
        Map<String,DeviceHolder> dm = this.getDeviceMap();
        if (dm.containsKey(devID)) {
            //Print.logInfo("Removing Device: " + devID);
            dm.remove(devID);
            return true;
        } else {
            return false;
    ...
    public boolean add(DeviceGroup group)
    {
        ...
        try {
            ...
            if (this.devGroup == null) {
                ...
                // -- DeviceGroup already defined
                Print.logInfo("DeviceGroup already defined: " + this.devGroup.getGroupID());
            }
            this.isGroup  = true;
            return true;
        } catch (DBException dbe) {
