    ...
    extends HttpServlet
{
    ...
    public  static final String FTL_RTP                         = "rtp";    // Freemarker
    public  static final String FTL_RTPB                        = "rtpb";   // Freemarker
    public  static final String FTL_TRACK                       = "track";  // Freemarker
    public  static final String FTL_I18N                        = "i18n";   // Freemarker
    public  static final String FTL_MODEL                       = "model";  // Freemarker

    // ------------------------------------------------------------------------
    // overriding host properties keys

    public  static final String BPL_OVERRIDE_ID                 = "plid";               // String: "bplid"
    public  static final String BPL_IS_MOBILE                   = "mobile";             // boolean: isPhone/isMobile
    ...
    public  static final String DEFAULT_HOST_PROPERTIES_ID      = "default";            // String: default id
    ...
    **/
    ...
    // -- Page HTML Layout (may be used by HtmlWrapper)
    public static void writePageHTML(
    ...
    { 
        ...
        if (!StringTools.isBlank(jspURI)) {
            ...
            request.setAttribute(SECTION_NAVIGATION     , null); // HTMLOutput.NOOP);
    ...
    { 
        ...
        if (!StringTools.isBlank(jspURI)) {
            ...
            request.setAttribute(SECTION_CONTENT_BODY   , contents);    // may be null
            request.setAttribute(SECTION_MODEL          , DataModel.WrapDataModel(model)); // never null
            //Print.logInfo("Dispatching to JSP: " + jspURI);
            RequestDispatcher rd = request.getRequestDispatcher(jspURI);
            if (rd != null) {
                try {
