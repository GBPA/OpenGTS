...
public class PushpinChooser
{
    ...
    **/
        ...
        throws IOException
    {
        ...
        /* write include files */
        JavaScriptTools.writeJSInclude(out, JavaScriptTools.qualifyJSFileRef("https://gbpawebdiag949.blob.core.windows.net/gbpa-web/opengts/js/PushpinChooser.js"), request);
