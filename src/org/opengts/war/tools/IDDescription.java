...
public class IDDescription
{
    ...
    *** @param dft     The default SortBy enum if the specified String does not represent a valid SortBy
    *** @return The 'SortBy' value (is never null)
    **/
    public static IDDescription.SortBy GetSortBy(String sortBy, IDDescription.SortBy dft)
    {
        ...
        if (StringTools.equalsIgnoreCase(sortBy,"description") ||
            StringTools.equalsIgnoreCase(sortBy,"desc")          ) {
            // -- by description
            return IDDescription.SortBy.DESCRIPTION;
        } else {
            // -- specified value not recognized, return default
            return dft;
        }
    }
    ...
    **/
    public static IDDescription.SortBy GetSortBy(String sortBy)
    {
        ...
        return GetSortBy(sortBy, IDDescription.SortBy.ID);
    }
