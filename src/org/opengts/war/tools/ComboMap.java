    ...
    extends OrderedMap<String,String>
{
    ...
    **/
    ...
    /**
    *** Returns a ComboMap containing a mapping of "default"/"false"/"true" to the localized text
    *** @param locale  The Locale
    *** @return The ComboMap
    **/
    public static ComboMap getTriStateMap(Locale locale)
    {
        I18N i18n = I18N.getI18N(ComboMap.class, locale);
        ComboMap triState = new ComboMap();
        triState.add(ComboOption.TRISTATE_NAME_DEFAULT, ComboOption.getTriStateText(locale, TriState.UNKNOWN));
        triState.add(ComboOption.TRISTATE_NAME_FALSE  , ComboOption.getTriStateText(locale, TriState.FALSE  ));
        triState.add(ComboOption.TRISTATE_NAME_TRUE   , ComboOption.getTriStateText(locale, TriState.TRUE   ));
        return triState;
    }
