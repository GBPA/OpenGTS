...
//     -Added FLD_sequence (order in which groupIDs were added to list)
// ----------------------------------------------------------------------------
    ...
    extends UserRecord<GroupList>
{
    ...
    private static DBField FieldInfo[] = {
        ...
        new DBField(FLD_sequence, Integer.TYPE, DBField.TYPE_INT32     , "Sequence"       , "edit=2"  ),
        // -- Common fields
    ...
    **/
    ...
    {
        this.setFieldValue(FLD_sequence, ((v >= 0)? v : 0));
    }
    ...
    protected static DBSelect<GroupList> _getUserListSelect(String acctId, String groupId)
    {
        ...
        throws DBException
    {
        ...
        /* get db selector */
        DBSelect<GroupList> dsel = GroupList._getUserListSelect(acctId, groupId);
        if (dsel == null) {
            return null;
        }
