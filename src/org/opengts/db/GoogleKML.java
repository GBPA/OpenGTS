...
//     -Changed Google pushpins to new location. [maps.gstatic.com/mapfiles/ridefinder-images]
// ----------------------------------------------------------------------------
...
public class GoogleKML
{
    ...
    {
        // GoogleKML.pushpinBaseURL=http://maps.gstatic.com/mapfiles/ridefinder-images/
        ...
        return RTConfig.getString(DBConfig.PROP_GoogleKML_pushpinBaseURL, 
          //"http://labs.google.com/ridefinder/images/"            // <-- no longer valid
            "http://maps.gstatic.com/mapfiles/ridefinder-images/"  // <-- alternate location [2.6.4-B43]
            );
    }
