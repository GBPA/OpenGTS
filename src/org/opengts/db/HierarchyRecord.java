...
public abstract class HierarchyRecord<RT extends DBRecord<RT>>
    extends AccountRecord<RT>
{
    ...
    */
    ...
    public static abstract class HierarchyKey<RT extends DBRecord<RT>>
    ...
    public static <RT extends HierarchyRecord<RT>> TreeNode/*<RT>*/ readHiearchy(DBFactory<RT> dbFact, Account acct)
        throws DBException
    {
