...
public class Main
{
    ...
    public static void main(String argv[])
    {
        ...
        Print.logInfo("Heartbeat ACK      : [TK103-1] " + TrackClientPacketHandler.TK103_HEARTBEAT_ACK);
        Print.logInfo("Logon ACK          : [TK103-2] " + TrackClientPacketHandler.TK103_LOGON_ACK);
        Print.logInfo("Alternate MobileID : [TK103-3] " + TrackClientPacketHandler.TK103_ALTERNATE_MOBILEID + 
            (TrackClientPacketHandler.TK103_ALTERNATE_MOBILEID?
             " [prefix \""+TrackClientPacketHandler.TK103_ALTERNATE_MOBILEID_P+"\"]":""));
        Print.logInfo(SEP);
