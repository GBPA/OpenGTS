...
public class Constants
{
    ...
    public static final String  VERSION                     = "0.2.45"; // 2.6.5-B50
    ...
    public static final String  CFG_returnAckOnLogon        = DEVICE_CODE + ".returnAckOnLogon";
    public static final String  CFG_returnAckOnHeartbeat    = DEVICE_CODE + ".returnAckOnHeartbeat";
    public static final String  CFG_returnAckOnKeepAlive    = DEVICE_CODE + ".returnAckOnKeepAlive"; // now returnAckOnLogon
    public static final String  CFG_useAlternateMobileID    = DEVICE_CODE + ".useAlternateMobileID";
    public static final String  CFG_alternateMobileIDPrefix = DEVICE_CODE + ".alternateMobileIDPrefix";
    public static final String  CFG_speedConversionFactor   = DEVICE_CODE + ".speedConversionFactor";
    public static final String  CFG_tk103_returnACK         = DEVICE_CODE + ".tk103.returnACK";
    public static final String  CFG_maximumDistanceSpeedKPH = DEVICE_CODE + ".maximumDistanceSpeedKPH";
