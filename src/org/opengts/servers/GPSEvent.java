...
//     -Added support for FLD_batteryVolts, FLD_vBatteryVolts
// ----------------------------------------------------------------------------
    ...
    implements GeoPointProvider
{
    ...
    **/
    ...
    public boolean insertEventData()
    {
        ...
        if (USE_EVENTDATA_SETVALUE) {
            ...
            if (this.hasBatteryVolts()  ) { evdb.setBatteryVolts(  this.getBatteryVolts());     }
            if (this.hasVBatteryVolts() ) { evdb.setVBatteryVolts( this.getVBatteryVolts());    }
        ...
        boolean isFleet, BasicPrivateLabel bpl) 
    {
        ...
        return 2; // PushpinIcon.ICON_PUSHPIN_RED;
    }
    ...
    **/
    ...
    {
        this.fieldValues.setDouble(EventData.FLD_batteryVolts, volts);
    }
    
    public boolean hasBatteryVolts()
    {
        return this.fieldValues.hasProperty(EventData.FLD_batteryVolts);
    }

    public double getBatteryVolts() 
    {
        return this.fieldValues.getDouble(EventData.FLD_batteryVolts, 0.0);
    }

    // ------------------------------------------------------------------------

    public void setVBatteryVolts(double volts) 
    {
        this.fieldValues.setDouble(EventData.FLD_vBatteryVolts, volts);
    }
    
    public boolean hasVBatteryVolts()
    {
        return this.fieldValues.hasProperty(EventData.FLD_vBatteryVolts);
    }

    public double getVBatteryVolts() 
    {
        return this.fieldValues.getDouble(EventData.FLD_vBatteryVolts, 0.0);
    }
