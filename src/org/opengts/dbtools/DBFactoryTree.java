...
public class DBFactoryTree
{
    ...
    ***/
    private static <T extends DBRecord<T>> void _traverseDBFactoryTree(int level, 
        DBFactory<T> dbFact, DBFactoryTree parentNode, Set<String> addedTables)
    {
    ...
    **/
    ...
    public static <T extends DBRecord<T>> DBFactoryTree[] getDBFactoryTree(DBFactory<T> initialFactory)
    {
    ...
    **/
    public static DBFactoryTree[] getDBFactoryTree(DBFactory<? extends DBRecord<?>> initialFactories[])
    {
        ...
        OrderedMap<String,DBFactory<? extends DBRecord<?>>> dbFactMap = new OrderedMap<String,DBFactory<? extends DBRecord<?>>>(DBAdmin.getTableFactoryMap());
