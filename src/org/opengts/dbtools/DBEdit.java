...
public class DBEdit
{
    ...
    private DBRecordKey<? extends DBRecord<?>>  recordKey = null;
    ...
    **/
    public DBEdit(DBRecordKey<? extends DBRecord<?>> key)
    {
        this.recordKey = key;
        ...
        for (int i = 0; i < fld.length; i++) {
            ...
            if (value != null) {
                ...
                if (enumMap != null) {
                    ...
                    Class<? extends Enum> enumClass = fld[i].getEnumClass();
                    Object e = EnumTools.getValueOf(enumClass, v);
                    sb.append("  [").append(e.toString()).append("]");
                } else
                if (maskMap != null) {
                    long v = (value instanceof Number)? ((Number)value).longValue() : 0L;
                    //@SupressWarnings("rawtypes")
                    Class<? extends Enum> enumClass = fld[i].getMaskClass();
                    Enum<?> m[] = EnumTools.getValuesForMask(enumClass, v);
                    if (m != null) {
                        sb.append("  [");
