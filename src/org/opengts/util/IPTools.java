...
public class IPTools
{
    ...
    **/
    ...
    /**
    *** Returns/Resolves an INet address for the specified host name.
    *** @param hostName A host name
    *** @return An INet address for the specified host name.
    **/
    public static InetAddress getInetAddress(String hostName)
    {
        try {
            return InetAddress.getByName(hostName);
        } catch (Throwable t) { // UnknownHostException
    ...
    /**
    *** Returns/Resolves an IP address for the specified host name.
    *** @param hostName A host name
    *** @return An IP address for the specified host name.
    **/
    public static String getIPAddress(String hostName)
    {
        InetAddress addr = IPTools.getInetAddress(hostName);
