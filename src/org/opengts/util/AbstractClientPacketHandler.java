...
//  2016/11/04  Martin D. Flynn
//     -Added 'getIdleTimeoutMillis', 'getPacketTimeoutMillis', 'getLineTerminatorChar'
// ----------------------------------------------------------------------------
    ...
    implements ClientPacketHandler
{
    ...
    **/
    ...
    private boolean                         sendResponse    = true; // send "getHandlePacket" response

    /**
    *** This constructor must remain for use with the OpenDMTP "gtsdmtp" DCS
    **/
    @Deprecated
    ...
    **/
    ...
    {
        ServerSocketThread.SessionInfo si = this.getSessionInfo();
        return (si != null)? si.isUDP() : !this.isDuplex;
    }
    ...
    **/
    ...
    {
        ServerSocketThread.SessionInfo si = this.getSessionInfo();
        return (si != null)? si.getAvailableBytes() : -1/*unknown*/;
    }
    ...
    **/
    ...
    /**
    *** Returns true if response from "getHandlePacket" should be sent back to client
    **/
