...
//     -Added "getSouthWest", "getSouthEast", "getNorthWest", "getNorthEast"
// ----------------------------------------------------------------------------
    ...
    implements Cloneable
{
    ...
    **/
    ...
    /**
    *** Gets the "Middle" point of the bounds
    ...
    **/
    ...
    /**
    *** Gets the SouthWest corner GeoPoint 
    **/
    public GeoPoint getSouthWest()
    {
        double lat = this.getMinLatitude();
        double lon = this.getMinLongitude();
        return new GeoPoint(lat, lon);
    }

    /**
    *** Gets the SouthEast corner GeoPoint 
    **/
    public GeoPoint getSouthEast()
    {
        double lat = this.getMinLatitude();
        double lon = this.getMaxLongitude();
        return new GeoPoint(lat, lon);
    }

    /**
    *** Gets the NorthWest corner GeoPoint 
    **/
    public GeoPoint getNorthWest()
    {
        double lat = this.getMaxLatitude();
        double lon = this.getMinLongitude();
        return new GeoPoint(lat, lon);
    }

    /**
    *** Gets the NorthEast corner GeoPoint 
    **/
    ...
    **/
    public String toString()
    {
        ...
        sb.append("MaxLat/Lon:");
            sb.append(StringTools.format(this.getMaxLatitude(),"0.00000"));
            sb.append("/");
            sb.append(StringTools.format(this.getMaxLongitude(),"0.00000"));
        sb.append(",");
        sb.append("MinLat/Lon:");
            sb.append(StringTools.format(this.getMinLatitude(),"0.00000"));
            sb.append("/");
            sb.append(StringTools.format(this.getMinLongitude(),"0.00000"));
       return sb.toString();
    }
