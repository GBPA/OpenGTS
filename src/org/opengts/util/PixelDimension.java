    ...
    implements Cloneable
{
    ...
    **/
    ...
    /**
    *** Constructor
    *** @param whStr  A String containing a comma or slash separated WIDTH and HEIGHT
    **/
    public PixelDimension(String whStr)
    {
        String wh[] = StringTools.parseStringArray(whStr, ",/");
        this.setWidth( (wh.length > 0)? StringTools.parseInt(wh[0],0) : 0);
        this.setHeight((wh.length > 1)? StringTools.parseInt(wh[1],0) : 0);
    }
